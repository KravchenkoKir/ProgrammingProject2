...
#conn is my variable for the table.
cur = conn.cursor()
...
# execute is for making actions, commit is for saving them
...
cur.execute("""INSERT INTO users(userid, fname, lname, gender) 
   VALUES('00001', 'Nikola', 'Kravčenko', 'female');""")
conn.commit()

user = ('00002', 'Amelie', "Sunrose", "female")
cur.execute("""INSERT INTO users VALUES(?,?,?,?);""", user)
# ^^^^^function ^^^^^^^^^^^^^^^^^code to insert, !! , !! then what we're inserting
conn.commit()

more_users = [('00003', 'Marion', 'Sunrose', 'male'), ('00004', 'Irya', 'Kallington', 'non-binary')]
# different variable for more people. Important to note the use of [] to combine the many people

cur.executemany("""INSERT INTO users VALUES(?, ?, ?, ?);""", more_users)
# executemany because we have multiple people into the table.
conn.commit()

customers = [
  ('00005', 'Roman', 'Kallington', 'male'), ('00006', 'Eric', 'Ironheart', 'male'), ('00007', 'Melonie', 'Runz', 'female'), 
